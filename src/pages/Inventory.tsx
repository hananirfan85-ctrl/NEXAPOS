...
export default function Inventory() {
  ...
  const handleDelete = async () => {
    ...
    const saleIds = Array.from(
      new Set(itemData?.map((item) => item.sale_id) || []),
    );
    ...
    if (!error) {
      logActivity(
        "DELETE_PRODUCT",
        `Erased product and all associated sales/records: ${name}`,
      );
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[800px] text-left text-sm text-gray-600">
            <thead className="bg-gray-50 border-b border-gray-100 text-gray-500 font-medium">
              <tr>
                <th className="px-6 py-4 rounded-tl-xl text-xs uppercase tracking-wider">
                  Product Name
                </th>
                ...
                <th className="px-6 py-4 rounded-tr-xl text-xs uppercase tracking-wider text-right">
                  Actions
                </th>
              </tr>
            </thead>
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <button
                        ...
                        className="text-gray-400 hover:text-indigo-600 transition-colors mx-2 p-1"
                      >
                        <Edit2 size={16} />
                      </button>
                      <button
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm overflow-hidden p-6 text-center">
            ...
            <p className="text-sm text-gray-500 mb-6">
              ...
              <span className="font-bold">{deleteCandidate.name}</span>? This
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      setFormData({
                        ...formData,
                        cost_price: isNaN(parsed) ? 0 : parsed,
                      });
                    }}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none"
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    inputMode="decimal"
                    value={
                      formData.selling_price === 0 ? "" : formData.selling_price
                    }
                    onChange={(e) => {
                      const parsed = parseFloat(e.target.value);
                      setFormData({
                        ...formData,
                        selling_price: isNaN(parsed) ? 0 : parsed,
                      });
                    }}
                    className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none"
                  />
              ...
              <div className="pt-4 flex justify-end gap-3 flex-wrap">
                ...
                <button
                  type="submit"
                  disabled={formLoad}
                  className="px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-lg hover:bg-indigo-700 focus:outline-none disabled:opacity-50"
                >
