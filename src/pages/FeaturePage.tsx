...
const features = {
  billing: {
    ...
    subtitle:
      "Lightning-fast checkout, built for extreme volume and complete offline reliability in Pakistan and beyond.",
    ...
    benefits: [
      "Sub-second transaction parsing",
      "Full offline synchronization via IndexedDB",
      "Search-based fast entry",
      "Direct cash tender support",
      "Tax & Discount computations",
    ],
    sections: [
      {
        icon: Zap,
      ...
      },
      {
        ...
        content:
          "Built on an offline-first service worker architecture. The POS doesn't just 'tolerate' being offline—it is fundamentally designed to function exactly the same without a network. Internet instability is common; your POS System shouldn't be. When disconnected, transactions are safely queued in the browser. When the network returns, an automatic synchronization engine safely flushes the ledger to the cloud.",
      },
      {
        icon: BarChart3,
        title: "Dynamic Price Adjustments",
        content:
          "Apply item markdowns and adjust quantities without complex configurations. The billing engine calculates tax and discounts on the fly directly inside the point of sale.",
      },
      {
        icon: Clock,
        title: "Receipt Generation",
        content:
          "Generate a detailed, professional digital receipt instantly upon cash checkout. The system records the transaction inside your sales ledger for complete documentation.",
      },
    ],
    seoContent: [
      {
      ...
      {
        heading:
          "Why Cloud-Based POS Systems Outperform Legacy Desktop Software",
  ...
  inventory: {
    ...
    subtitle:
      "Track every SKU across all locations with surgical precision and cloud persistence.",
    ...
    benefits: [
      ...
      "Detailed catalog structuring",
      "Simplified category filtering",
      "Streamlined price management",
      "Cloud-synchronized quantities",
    ],
    sections: [
      {
        icon: BarChart3,
        ...
        content:
          "Stop wrestling with messy spreadsheets. NEXA POS allows you to structure your entire catalog into localized categories. Drill down your inventory by type, and instantly filter through your catalog during restocks or inventory audits.",
      },
      {
        icon: ShieldCheck,
        title: "Immutable Stock Ledgers",
        content:
          "Every single sales movement is mathematically consistent. Because the POS directly ties to the inventory module, every time a cashier completes a checkout, the exact quantities are subtracted from your total stock in real-time.",
      },
      {
        icon: Zap,
        title: "Total Catalog Visibility",
        content:
          "Instantly view the total count of distinct items across your entire retail space, ensuring your warehouse team knows exactly what exists in the system without manually counting.",
      },
      {
        icon: Rocket,
        title: "Simplified Product Editing",
        content:
          "Quickly manage stock and pricing across your entire retail catalog. Editing product names, adjusting retail prices, or updating quantities is streamlined. The changes propagate down to every physical terminal instantly.",
      },
    ],
    seoContent: [
      {
  ...
  reports: {
    ...
    subtitle:
      "Actionable sales insights and data visualizations, generated the moment you sell.",
    ...
    benefits: [
      "Live profit/loss dashboards",
      "Gross revenue graphical charting",
      "Profit trend lines",
      "Granular historical analytics",
    ...
    sections: [
      {
        ...
        content:
          "Watch your business pulse in real-time. The main dashboard aggregates gross revenue, net profit, and total sales counts instantly as sales occur at the register. We utilize high-performance charting libraries to render this data smoothly.",
      },
      {
        icon: Rocket,
        title: "Daily Revenue Charting",
        content:
          "NEXA POS visually graphs your sales over historical periods, helping you easily identify which days had the highest gross revenue. Understand your weekly sales cycles physically through interactive bar and line charts.",
      },
      {
        icon: ShieldCheck,
        title: "Printable Sales Ledgers",
        content:
          "Accountants require hard data. Easily navigate through the detailed 'Sales' page to find chronological, immutable logs of every receipt printed. These records can be filtered and printed for legal tax filing and internal financial audits.",
      },
      {
        icon: Clock,
        title: "Data Reliability & Speed",
        content:
          "Your reports are instantly generated directly from your sales ledger. No manual spreadsheet export required to know your monthly standing. Supabase handles the complex aggregations, returning your data to the dashboard in milliseconds.",
      },
    ],
    seoContent: [
      {
  ...
  crm: {
    ...
    subtitle:
      "Track customer loyalty, manage accounts, and retain your most valuable clients.",
    ...
    benefits: [
      ...
      "Digital Customer Ledgers & Balances",
    ...
    sections: [
      {
        ...
        content:
          "Keep all client information safely stored. Phone numbers, emails, addresses, and identifying parameters are easily accessible to the management team.",
      },
      {
        icon: Zap,
        title: "Digital Customer Ledgers",
        content:
          "Managing B2B accounts or regular clients who maintain a running balance is finally easy. NEXA POS allows you to track exactly how much a customer owes your business, record partial payments, and view their complete ledger history.",
      },
      {
        icon: Rocket,
        title: "Loyalty Points Tracking",
        content:
          "NEXA POS stores loyalty points so you can easily identify your most valuable customers, assigning VIP visual tags dynamically.",
      },
    ],
    seoContent: [
      {
  ...
  users: {
    ...
    subtitle:
      "Manage roles and delegate operational capabilities without losing control.",
    ...
    sections: [
      {
        ...
        content:
          "Not all employees need to see the net profit charts. NEXA POS cleanly delineates between 'Administrators' and 'Cashiers'. Floor staff only see what they uniquely require to complete transactions, while owners retain supreme command over settings and analytics.",
      },
      {
        icon: Zap,
        title: "Admin Panel Configuration",
        content:
          "Set up your database easily through the integrated Admin Panel. Complete control over your entire Postgres architecture allows for robust system deployments and user creations.",
      },
      {
        icon: Clock,
        title: "Rapid Deployment",
        content:
          "If an employee joins the company, their access can be instantly created from the central database. Because the authentication is handled rapidly via Supabase cloud tokens, onboarding is secure and robust.",
      },
    ],
    seoContent: [
      {
  ...
  cashflow: {
    ...
    subtitle:
      "Track every income and operational expense to realize your true net standing.",
    ...
    benefits: [
      ...
      "Live Net Balance Recalculation",
    ...
    sections: [
      {
        ...
        content:
          "Understand your true financial standing at a glance. By actively inputting localized operational expenses against your automated POS sales income, the dashboard will actively render your true liquid net balance.",
      },
      {
        icon: Clock,
        title: "Chronological Logs",
        content:
          "Log daily expenses manually. Scroll back through months of chronological data to pinpoint exactly where your capital is leaking, helping you restructure budgets to increase total margins.",
      },
      {
        icon: ShieldCheck,
        title: "Isolated Financial Data",
        content:
          "The cashflow ledger is kept distinct from your retail inventory sales, allowing you to clearly see the dividing line between gross product profit and overarching operational business expenses.",
      },
    ],
    seoContent: [
      {
  ...
  if (!feature) {
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 text-center text-white">
        ...
        <Link
          to="/home"
          className="text-indigo-500 hover:text-indigo-400 font-mono tracking-widest uppercase"
        >
          Return to Home
        </Link>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 border-x border-white/5 bg-black/20 backdrop-blur-3xl min-h-screen">
        ...
        <div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12 mb-16 backdrop-blur-xl shadow-2xl">
            <h3 className="text-sm font-mono text-indigo-400 tracking-widest uppercase mb-4">
              Architecture Brief
            </h3>
            ...
            <h3 className="text-sm font-mono text-indigo-400 tracking-widest uppercase mb-6">
              Execution Pillars
            </h3>
          ...
          {feature.seoContent && feature.seoContent.length > 0 && (
            <div className="mt-24 max-w-4xl mx-auto bg-black/40 border border-white/10 p-8 md:p-12 lg:p-16 rounded-3xl backdrop-blur-md">
              <h2 className="text-4xl font-display font-bold text-white mb-12 border-b border-white/10 pb-4">
                In-Depth Technical Insights & Industry Architecture
              </h2>
          ...
          <div className="mt-32 pb-16 text-center border-t border-white/10 pt-16">
            ...
            <Link
              to="/signup"
              className="inline-flex justify-center items-center gap-3 rounded-full bg-indigo-600 px-8 py-4 text-sm font-mono tracking-widest font-bold text-white shadow-xl shadow-indigo-600/30 hover:bg-indigo-500 hover:scale-[1.02] transition-all uppercase"
            >
