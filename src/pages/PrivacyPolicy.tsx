    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans p-4 md:p-8 lg:p-16">
      <div className="max-w-4xl mx-auto bg-white p-8 lg:p-12 rounded-3xl shadow-sm border border-gray-100">
        ...
        <div className="prose prose-lg text-gray-600 max-w-none space-y-8">
          <p>
            At NEXA POS, accessible from our application platform, one of our
            main priorities is the privacy of our visitors and registered
            clients. This Privacy Policy document contains types of information
            that is collected and recorded by NEXA POS and how we use it.
          </p>
          <p>
          ...
          <section>
            ...
            <p>
              When you register for our <strong>Retail POS Software</strong>, we
              ...
              information is vital to provision your dedicated workspace within
            ...
            <p>
              ...
              strictly records your operational data. This includes:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
              <li>
                Customer contact metrics and historical product purchase logs.
              </li>
              <li>
                Financial logs involving the <strong>Billing Software</strong>{" "}
                ledgers.
              </li>
              <li>
                Inventory SKU counts, categorized item variants, and metadata.
              </li>
              <li>
                User analytical behaviors to optimize dashboard UI performance.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              guarantee an operational <strong>POS System in Pakistan</strong>.
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
              ...
              <li>
                ...
                our interfaces to reduce friction.
              </li>
              <li>
                Develop new features for the{" "}
                <strong>Inventory Management Software</strong>, such as AI
                forecasting and shortage warnings.
              </li>
              <li>
                Communicate with you directly for customer service, to provide
                updates, and handle support requests involving the{" "}
          ...
          <section>
            ...
            <p>
              ...
              Since our application functions as a robust Progressive Web App
              (PWA) <strong>POS System in Pakistan</strong>, it deeply
              integrates with your local browser storage (IndexedDB and
              ...
              will not cease operations if internet connectivity vanishes.
            </p>
            <p>
              Once connectivity restores, our{" "}
              <strong>Shop Management System</strong> syncs encrypted data back
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">
              4. Third-Party Privacy Policies and Infrastructure
            </h2>
            <p>
              NEXA POS's Privacy Policy does not apply to other advertisers or
              websites. Our <strong>Inventory Management Software</strong> is
              ...
              intersect or read unauthorized data.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4 text-gray-700">
              <li>
                ...
                request copies of your personal data. We provide export features
              ...
              <li>
                ...
                customer lists, and product matrixes from our servers.
              </li>
            </ul>
          </section>
        </div>
