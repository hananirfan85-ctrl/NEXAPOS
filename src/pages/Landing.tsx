  ...
  return (
    <div className="relative min-h-screen font-sans selection:bg-indigo-500/30 selection:text-white overflow-hidden bg-[#0a0a0c]">
      ...
      <div className="relative z-10">
        {/* Navigation */}
        <nav className="fixed top-0 w-full bg-[#0a0a0c]/80 backdrop-blur-xl border-b border-white/5 z-50 transition-all">
              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                {deferredPrompt && (
                  <button
                    ...
                    className="text-sm font-sans font-medium text-white border border-white/20 hover:bg-white/10 px-4 py-2 rounded-lg transition-all flex items-center gap-2"
                  >
                ...
                <Link
                  to="/signup"
                  className="text-sm font-sans font-bold text-white bg-indigo-600 hover:bg-indigo-500 px-5 py-2.5 rounded-lg transition-all shadow-lg shadow-indigo-600/20"
                >
                  Get Started
                </Link>
              </div>
          ...
          {/* Mobile Nav Dropdown */}
          {isMobileMenuOpen && (
            <div className="md:hidden bg-[#0c0c0e] border-b border-white/10 px-4 pt-2 pb-6 space-y-4">
              <Link
                to="/about"
              ...
              <div className="pt-4 border-t border-white/10">
                <Link
                  to="/signup"
                  className="flex justify-center w-full text-base font-bold text-white bg-indigo-600 hover:bg-indigo-500 px-5 py-3 rounded-lg transition-all"
                  onClick={() => setIsMobileMenuOpen(false)}
                >
